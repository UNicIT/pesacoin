...
uint256 hashGenesisBlock("0x985a155532dc290adaa4a570f3eace7ff5c4b3ae67f2c3bb447e90ef2ca61cc9");
...
static const int64 nTargetTimespan = 1 * 48 * 60 * 60; // pesacoin: 2 days
static const int64 nTargetSpacing = 180; // pesacoin: 3 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal pesacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "pesacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1492251683; //epochtime
        ...
        //// debug print 2fc1b7ef46270c053711fbae934cf7f83378efd4b3e158079451d9c6c90e4700 testnet
        printf("%s\n", block.GetHash().ToString().c_str());
        printf("%s\n", hashGenesisBlock.ToString().c_str());
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        assert(block.hashMerkleRoot == uint256("0x30f45161daf297abf43af51debc254d3d616b34a7cbf78030eae4c7c973e959e"));
